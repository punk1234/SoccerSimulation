 ...
 */
public class LinearModelTrainingSetBuilder implements TrainingSetBuilder {

    private int numberOfColumns;
    private ResultProcessor resultProcessor;

    public LinearModelTrainingSetBuilder(int numberOfColumns, ResultProcessor resultProcessor){
    ...
    private double getTeamPerformance(String teamName){

        return 0;

    }

    public double getGoalsScored(String teamName){

        return 0;

    }

    public double getGoalsConceded(String teamName){

        return 0;

    }

    public TrainingSet convertToClassification(){
